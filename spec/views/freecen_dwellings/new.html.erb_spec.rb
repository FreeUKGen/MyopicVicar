...
describe "freecen_dwellings/new" do
  before(:each) do
    assign(:freecen_dwelling, stub_model(FreecenDwelling,
      :entry_number => 1,
  ...
  it "renders new freecen_dwelling form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", freecen_dwellings_path, "post" do
