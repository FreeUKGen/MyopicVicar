...
describe "freereg1_csv_entries/new" do
  before(:each) do
    assign(:freereg1_csv_entry, stub_model(Freereg1CsvEntry,
      :abode => "MyString",
      :age => "MyString",
      :baptdate => "MyString",
      :birthdate => "MyString",
  ...
  it "renders new freereg1_csv_entry form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => freereg1_csv_entries_path, :method => "post" do
