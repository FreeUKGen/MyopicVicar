...
describe "freecen1_vld_entries/edit" do
  before(:each) do
  ...
  it "renders the edit freecen1_vld_entry form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", freecen1_vld_entry_path(@freecen1_vld_entry), "post" do
      ...
      assert_select "input#freecen1_vld_entry_parish[name=?]", "freecen1_vld_entry[parish]"
      ...
      assert_select "input#freecen1_vld_entry_condition[name=?]", "freecen1_vld_entry[condition]"
