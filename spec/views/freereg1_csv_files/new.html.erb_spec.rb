...
describe "freereg1_csv_files/new" do
  before(:each) do
    assign(:freereg1_csv_file, stub_model(Freereg1CsvFile,
      :dir_name => "MyString",
      :file_name => "MyString",
  ...
  it "renders new freereg1_csv_file form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => freereg1_csv_files_path, :method => "post" do
