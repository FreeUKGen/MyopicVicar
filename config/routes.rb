...
MyopicVicar::Application.routes.draw do
  ...
  get 'search_queries/:id/download_as_tsv' => 'search_queries#download_as_tsv', as: :search_results_download_as_tsv
  ...
  get ':entry_id/reference_details', to: 'best_guess#show_reference_entry', as: :show_reference_entry_non_search
