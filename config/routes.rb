...
MyopicVicar::Application.routes.draw do
  ...
  get 'manage_counties/selection', to: 'manage_counties#review_all_freecen2_pieces', constraints: ManageCountiesReviewAllFreecen2PiecesConstraint, as: :review_all_freecen2_pieces_manage_counties
  ...
  get 'manage_counties/piece_selection_by_name', to: 'manage_counties#piece_selection_by_name', as: :piece_selection_by_name_manage_counties
  get 'manage_counties/piece_selection_by_number', to: 'manage_counties#piece_selection_by_number', as: :piece_selection_by_number_manage_counties
  get 'manage_counties/piece_selection_by_year', to: 'manage_counties#piece_selection_by_year', as: :piece_selection_by_year_manage_counties
