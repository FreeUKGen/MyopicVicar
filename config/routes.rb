...
MyopicVicar::Application.routes.draw do
  ...
  get 'manage_syndicates/manage_incomplete_registrations', :to =>'manage_syndicates#manage_incomplete_registrations', :as => :manage_incomplete_registrations_userid_details
