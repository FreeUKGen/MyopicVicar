desc "set_individual_fc2 parameter linkgaes for VLD files, dwelling, individuals and search records"
task :set_individual_fc2_parameters, [:file, :search_records] => [:environment] do |t, args|
