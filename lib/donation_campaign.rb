...
#
# When active: show donate CTA dialog, load per-app fuse_tag JS where present, do not load async Publift in <head>.
# When inactive: hide CTA, load head Publift scripts, do not load per-app fuse_tag JS.
