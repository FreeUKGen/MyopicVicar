...
#process the first 4 columns of the data record
            ...
            def self.check_and_create_db_record_for_entry(data_record)
              if @@update 
                ...
                record_exists = Freereg1CsvEntry.where(:freereg1_csv_file_id => @freereg1_csv_file._id, :record_digest => new_digest).hint("freereg1_csv_file_id_1_1_record_digest_1").only(:id).first
