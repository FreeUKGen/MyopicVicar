			...
			subsections: [
				{
					...
					answer: <<~HTML.strip,
						...
						<p>Enter the correct information in the relevant field(s) on the form below. Please read our <%= link_to "Privacy Notice", Constant::PRIVACY_POLICY_LINK %> for information on how we will protect and use your data, and then complete the form below.</p>
					HTML
					show_form: true
				},
