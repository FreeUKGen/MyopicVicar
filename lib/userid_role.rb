module UseridRole
  VALUES = ['researcher','trainee','pending', 'transcriber','syndicate_coordinator','county_coordinator','country_coordinator',
    ...
    OPTIONS = {'researcher' => ["Saved Searches", "Profile", "Help"], 
      ...
      'county_coordinator' =>  ["Saved Searches", "Profile", "Files", "Manage County",  "Help"],
      'country_coordinator' => ["Saved Searches", "Profile", "Files", "Manage Syndicate", "Manage County" "Help"],
      'volunteer_coordinator' => ["Saved Searches", "Profile", "Files", "Manage Syndicates", "Manage Userids",  "Help"],
      'data_manager' => ["Saved Searches", "Profile", "Files", "Manage Counties", "Access Userids",  "Help"],
