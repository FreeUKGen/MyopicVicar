module UseridRole
  ...
  when 'freereg'
    OPTIONS = {
      'researcher' => ['Communicate', 'Profile', 'Coordinators list', 'FreeREG FreeREG Roadmap','FreeUKGenealogy  Policies'],
      'computer' => ['Profile', 'FreeREGFreeREG Roadmap'],
      'trainee' => ['Assignments', 'Batches', 'Communicate', 'Profile', 'Batches',  'Coordinators list', 'FreeREG Roadmap', 'FreeUKGenealogy  Policies'],
      'pending' => ['Profile'],
      'transcriber' => ['Assignments', 'Batches', 'Communicate', 'Profile','FreeREG Roadmap', 'Coordinators list', 'FreeUKGenealogy  Policies'],
      'syndicate_coordinator' => ['Assignments', 'Batches', 'Communicate',  'Coordinators list', 'Manage Syndicate', 'Profile', 'FreeREG Roadmap', 'FreeUKGenealogy  Policies'],
      'contacts_coordinator' => ['Assignments', 'Batches', 'Communicate', 'Contacts', 'Transcriber Statistics', 'Display Communications Coordinators',
                                 'Coordinators list', 'Display Userids', 'Feedback', 'Message System','Manage Counties', 'Profile', 'System Documentation', 'FreeREG Roadmap', 'FreeUKGenealogy  Policies'],
      'county_coordinator' => ['Assignments', 'Coordinators list', 'Batches', 'Communicate', 'Contacts',  'Display Userids', 'Manage County', 'Manage Syndicate', 'Profile', 'FreeREG Roadmap', 'FreeUKGenealogy  Policies'],
      'country_coordinator' => ['Assignments', 'Coordinators list', 'Batches', 'Communicate', 'Contacts', 'Display Userids', 'Manage County', 'Manage Syndicate', 'Profile', 'FreeREG Roadmap', 'FreeUKGenealogy  Policies'],
      'volunteer_coordinator' => ['Assignments', 'Coordinators list', 'Batches', 'Communicate', 'Contacts', 'Manage Syndicates', 'Manage Userids', 'Profile', 'FreeREG Roadmap', 'FreeUKGenealogy  Policies'],
      'data_manager' => ['Access Attic', 'Assignments', 'Batches', 'Communicate', 'Contacts', 'Denominations', 'Display Userids',  'Coordinators list',
                         'Manage Counties', 'Manage Syndicates', 'Physical Files', 'Profile', 'FreeREG Roadmap' ],
      'technical' => ['Access Attic', 'Assignments', 'Batches', 'Communicate', 'Coordinators list', 'Manage Assignments', 'Contacts', 'Feedback', 'Profile', 'FreeREG Roadmap',  'Search Performance', 'Site Statistics',
      ...
      'executive_director' => ['Upload Report','Access Attic', 'Assignments', 'Batches', 'Communicate', 'Contacts', 'County Coordinators', 'Coordinators list', 'Denominations', 'GAP Reasons', 'Feedback',
                               'Manage Counties', 'Manage Image Server', 'Manage Syndicates', 'Manage Userids', 'Message System',  'Physical Files', 'Profile',  'FreeREG Roadmap', 'Search Performance', 'Site Statistics',
                               'Software Version Information', 'System Documentation', 'FreeUKGenealogy  Policies'],
      'publicity_coordinator' => ['Assignments', 'Batches', 'Communicate', 'Contacts', 'Coordinators list', 'Profile', 'FreeREG Roadmap', 'System Documentation', 'FreeUKGenealogy  Policies'],
      'genealogy_coordinator' => ['Assignments', 'Batches', 'Communicate', 'Contacts', 'Coordinators list', 'Profile', 'FreeREG Roadmap', 'System Documentation', 'FreeUKGenealogy  Policies'],
      'documentation_coordinator' => ['Assignments', 'Batches', 'Communicate', 'Coordinators list', 'Display Userids', 'Feedback', 'Manage Syndicates',
                                      'Manage Counties', 'Profile',  'FreeREG Roadmap', 'System Documentation', 'FreeUKGenealogy  Policies'],
      'engagement_coordinator' => ['Assignments', 'Batches', 'Communicate', 'Contacts', 'Coordinators list', 'Manage Userids', 'Feedback', 'Message System', 'Profile',  'Site Statistics', 'FreeREG Roadmap', 'System Documentation', 'FreeUKGenealogy  Policies'],
      'website_coordinator' => ['Batches', 'Contacts', 'Communicate', 'Coordinators list', 'Display Userids', 'Feedback', 'Message System', 'Profile',  'FreeREG Roadmap', 'System Documentation', 'FreeUKGenealogy  Policies'],
      'general_communication_coordinator' => ['Batches', 'Contacts', 'Communicate', 'Coordinators list', 'Display Userids', 'Feedback', 'Message System', 'Profile',  'FreeREG Roadmap', 'System Documentation', 'FreeUKGenealogy  Policies'],
      'image_server_coord' => ['Profile', 'Coordinators list', 'Image Server','FreeUKGenealogy Policies']
    }
  when 'freecen'
    OPTIONS = {
      'checker' => ['CSV Batches', 'Gazetteer', 'FreeCEN Handbook', 'Communicate', 'Profile', 'FreeCEN Roadmap', 'Display County Coordinators', 'Display Syndicate Coordinators', 'FreeUKGenealogy  Policies'],
      'computer' => ['CSV Batches', 'Profile', 'FreeCEN Roadmap', 'Display County Coordinators', 'Display Syndicate Coordinators',  'FreeUKGenealogy  Policies'],
      'researcher' => ['Communicate', 'Profile', 'FreeCEN Roadmap', 'Display County Coordinators', 'Display Syndicate Coordinators',  'FreeUKGenealogy  Policies'],
      ...
      'contacts_coordinator' => ['CSV Batches', 'Communicate', 'Contacts', 'Display County Coordinators', 'Display Communications Coordinators',
                                 'Display Syndicate Coordinators', 'Display Userids', 'Feedback', 'Gazetteer', 'Manage Counties', 'Profile', 'Transcriber Statistics', 'System Documentation', 'FreeCEN Roadmap', 'FreeCEN Handbook', 'FreeUKGenealogy  Policies'],
      'county_coordinator' => ['CSV Batches', 'Gazetteer', 'Gazetteer CSV Download', 'FreeCEN Handbook', 'Manage Counties', 'Manage Syndicates', 'Site Statistics', 'Contacts', 'Communicate', 'Display Userids', 'Profile',  'FreeCEN Roadmap', 'Display County Coordinators', 'Display Syndicate Coordinators',  'FreeUKGenealogy  Policies'],
      'master_county_coordinator' => ['CSV Batches', 'Gazetteer', 'FreeCEN Handbook', 'Manage Counties', 'Manage Syndicates', 'Site Statistics', 'Contacts', 'Communicate', 'Display Userids', 'Profile',  'FreeCEN Roadmap', 'Display County Coordinators', 'Display Syndicate Coordinators',  'FreeUKGenealogy  Policies'],
      'country_coordinator' => ['CSV Batches', 'Communicate', 'Contacts', 'Display Userids', 'Gazetteer', 'Manage County', 'Manage Syndicate', 'Profile', 'FreeCEN Roadmap', 'FreeCEN Handbook', 'Display County Coordinators', 'Display Syndicate Coordinators',  'FreeUKGenealogy  Policies'],
      'data_manager' => ['CSV Batches', 'Gazetteer', 'Finalise Scottish PARMS','FreeCEN Handbook', 'Manage Counties', 'Manage Syndicates', 'Place Edit Reasons', 'Place Sources', 'FreeCen Errors', 'Physical Files', 'Communicate', 'Contacts', 'Database Statistics', 'Access Attic', 'Display Userids', 'Display Syndicate Coordinators', 'Display County Coordinators', 'Profile',
                         'FreeCEN Roadmap', 'FreeUKGenealogy  Policies'],
      'documentation_coordinator' => ['CSV Batches', 'Communicate', 'Display Userids', 'Feedback', 'Gazetteer', 'Manage Syndicates',
                                      'Manage Counties', 'Profile',  'FreeCEN Roadmap', 'System Documentation', 'FreeCEN Handbook', 'Display County Coordinators', 'Display Syndicate Coordinators',  'FreeUKGenealogy  Policies'],
      'engagement_coordinator' => ['CSV Batches', 'Communicate', 'Contacts', 'Database Statistics', 'Manage Userids', 'Manage Counties', 'Manage Syndicates', 'Feedback', 'Message System',
                                   ...
                                   'Syndicate Coordinators', 'Profile',  'FreeCEN Roadmap', 'Gazetteer', 'System Documentation',
      ...
      'executive_director' => ['Upload Report','GAP Report','Access Attic', 'CSV Batches', 'Communicate', 'Contacts', 'County Coordinators', 'Country Coordinators', 'Database Statistics', 'Feedback', 'FreeCen Errors', 'Gazetteer',
                               'Manage Counties', 'Manage Syndicates', 'Manage Userids', 'Message System', 'Profile',  'Roadmap', 'Search Statistics', 'Search Performance', 'Site Statistics',
      ...
      'genealogy_coordinator' => ['CSV Batches', 'Communicate', 'Contacts', 'Profile', 'FreeCEN Roadmap', 'Gazetteer', 'System Documentation', 'FreeCEN Handbook', 'Display County Coordinators', 'Display Syndicate Coordinators',  'FreeUKGenealogy  Policies'],
      'general_communication_coordinator' => ['CSV Batches', 'Communicate', 'Display Userids', 'Feedback', 'Gazetteer', 'Message System', 'Profile',  'FreeCEN Roadmap', 'System Documentation', 'FreeUKGenealogy  Policies'],
      'project_manager' => ['Access Attic', 'CSV Batches', 'Communicate', 'Contacts', 'County Coordinators', 'Country Coordinators', 'Database Statistics', 'Feedback', 'FreeCen Errors', 'Gazetteer',
                            'Manage Counties', 'Manage Syndicates', 'Manage Userids', 'Message System', 'Profile',  'Roadmap','Search Statistics', 'Search Performance', 'Site Statistics',
                            'Software Version Information', 'Syndicate Coordinators', 'System Documentation', 'TNA Change Logs', 'FreeCEN Handbook', 'FreeUKGenealogy  Policies'],
      'publicity_coordinator' => ['CSV Batches', 'Communicate', 'Contacts', 'Profile', 'FreeCEN Roadmap', 'Gazetteer', 'System Documentation', 'FreeCEN Handbook', 'Display County Coordinators', 'Display Syndicate Coordinators', 'FreeUKGenealogy  Policies'],
      'syndicate_coordinator' => ['CSV Batches', 'Gazetteer', 'FreeCEN Handbook', 'Manage Syndicate', 'Contacts', 'Communicate', 'Display Userids', 'Profile',  'FreeCEN Roadmap', 'FreeUKGenealogy  Policies', 'Display County Coordinators', 'Display Syndicate Coordinators'],
      'system_administrator' => ['Upload Report', 'Find Pieces','Finalise Scottish PARMS','Access Attic', 'CSV Batches', 'Communicate', 'Contacts', 'Display Communications Coordinators', 'County Coordinators', 'Country Coordinators', 'Database Statistics', 'Gazetteer CSV Download', 'Feedback', 'FreeCen Errors', 'Gazetteer',
                                 'Manage Counties', 'Manage Syndicates', 'Manage Userids', 'Message System', 'Place Edit Reasons', 'Place Sources', 'Physical Files', 'Profile',  'Roadmap', 'Search Statistics', 'Search Performance', 'Site Statistics',
      ...
      'trainee' => ['CSV Batches', 'Communicate', 'Profile', 'FreeCEN Roadmap', 'Gazetteer', 'FreeCEN Handbook','Display County Coordinators', 'Display Syndicate Coordinators', 'FreeUKGenealogy  Policies'],
      'technical' => ['Access Attic', 'CSV Batches', 'Communicate', 'Contacts', 'Database Statistics', 'Feedback', 'FreeCen Errors', 'Gazetteer', 'Profile',  'FreeCEN Roadmap','Search Statistics', 'Search Performance', 'Site Statistics',
      ...
      'transcriber' => ['CSV Batches', 'Gazetteer', 'FreeCEN Handbook', 'Communicate', 'Profile', 'FreeCEN Roadmap', 'Display County Coordinators', 'Display Syndicate Coordinators',  'FreeUKGenealogy  Policies'],
      'transcriber_special_powers' => ['CSV Batches', 'Gazetteer', 'FreeCEN Handbook', 'Communicate', 'Contacts', 'Profile', 'FreeCEN Roadmap', 'Display County Coordinators', 'Display Syndicate Coordinators',  'FreeUKGenealogy  Policies'],
      'validator' => ['CSV Batches', 'Gazetteer', 'Gazetteer CSV Download', 'FreeCEN Handbook', 'Communicate', 'Profile', 'FreeCEN Roadmap', 'Display County Coordinators', 'Display Syndicate Coordinators', 'FreeUKGenealogy  Policies'],
      'volunteer_coordinator' => ['CSV Batches', 'Communicate', 'Contacts', 'Gazetteer', 'Manage Syndicates', 'Manage Userids', 'Profile', 'FreeCEN Roadmap', 'FreeCEN Handbook', 'Display County Coordinators', 'Display Syndicate Coordinators', 'FreeUKGenealogy  Policies'],
      'website_coordinator' => ['CSV Batches', 'Communicate', 'Contacts', 'Database Statistics', 'Display Userids', 'Feedback', 'Gazetteer', 'Message System','Place Edit Reasons', 'Profile',  'FreeCEN Roadmap', 'System Documentation', 'FreeCEN Handbook', 'Display County Coordinators', 'Display Syndicate Coordinators',  'FreeUKGenealogy  Policies'],
      ...
      'reporter_transcriber' => ['CSV Batches', 'Find Pieces', 'Gazetteer', 'FreeCEN Handbook', 'Communicate', 'Profile', 'FreeCEN Roadmap', 'Display County Coordinators', 'Display Syndicate Coordinators', 'FreeUKGenealogy  Policies', 'Manage Counties', 'GAP Report']
    }
  end
  ...
  OPTIONS_TRANSLATION = {
    ...
    'FreeCEN Handbook' => '/freecen-handbook',
    ...
    'Finalise Scottish PARMS' => '/freecen2_pieces/finalise_sct_parms',
  ...
  OPTIONS_TITLES = {
    ...
    'FreeREG Roadmap' => 'Review the future FreeREG Roadmap for the application',
