module UseridRole
  ...
  when 'freereg'
    OPTIONS = {
      ...
      'technical' => ['Access Attic', 'Assignments', 'Batches', 'Communicate', 'Coordinators list', 'Manage Assignments', 'Contacts', 'Feedback', 'Profile', 'RefineryCMS', 'FreeREG Roadmap',  'Search Performance', 'Site Statistics',
      ...
      'system_administrator' => ['Upload Report','Access Attic', 'Assignments', 'Batches', 'Communicate', 'Contacts', 'County Coordinators', 'Country Coordinators', 'Denominations',  'Display Communications Coordinators', 'GAP Reasons', 'Feedback',
                                 'Manage Counties', 'Manage Image Server', 'Manage Syndicates', 'Manage Userids', 'Message System',  'Physical Files', 'Profile', 'RefineryCMS', 'FreeREG Roadmap',
      ...
      'project_manager' => ['Access Attic', 'Assignments', 'Batches', 'Communicate', 'Contacts', 'Coordinators list', 'Country Coordinators', 'Denominations', 'GAP Reasons', 'Feedback',
                            'Manage Counties', 'Manage Image Server', 'Manage Syndicates', 'Manage Userids', 'Message System',  'Physical Files', 'Profile', 'RefineryCMS', 'FreeREG Roadmap', 'Search Performance', 'Site Statistics',
      ...
      'documentation_coordinator' => ['Assignments', 'Batches', 'Communicate', 'Coordinators list', 'Display Userids', 'Feedback', 'Manage Syndicates',
                                      'Manage Counties', 'Profile', 'RefineryCMS', 'FreeREG Roadmap', 'System Documentation', 'FreeUKGenealogy  Policies'],
      'engagement_coordinator' => ['Assignments', 'Batches', 'Communicate', 'Contacts', 'Coordinators list', 'Manage Userids', 'Feedback', 'Message System', 'Profile', 'RefineryCMS', 'Site Statistics', 'FreeREG Roadmap', 'System Documentation', 'FreeUKGenealogy  Policies'],
      'website_coordinator' => ['Batches', 'Contacts', 'Communicate', 'Coordinators list', 'Display Userids', 'Feedback', 'Message System', 'Profile', 'RefineryCMS', 'FreeREG Roadmap', 'System Documentation', 'FreeUKGenealogy  Policies'],
      'general_communication_coordinator' => ['Batches', 'Contacts', 'Communicate', 'Coordinators list', 'Display Userids', 'Feedback', 'Message System', 'Profile', 'RefineryCMS', 'FreeREG Roadmap', 'System Documentation', 'FreeUKGenealogy  Policies'],
  ...
  when 'freecen'
    OPTIONS = {
      ...
      'documentation_coordinator' => ['CSV Batches', 'Communicate', 'Display Userids', 'Feedback', 'Gazetteer', 'Manage Syndicates',
                                      'Manage Counties', 'Profile', 'RefineryCMS', 'FreeCEN Roadmap', 'System Documentation', 'FreeCEN Handbook', 'Display County Coordinators', 'Display Syndicate Coordinators',  'FreeUKGenealogy  Policies'],
      'engagement_coordinator' => ['CSV Batches', 'Communicate', 'Contacts', 'Database Statistics', 'Manage Userids', 'Manage Counties', 'Manage Syndicates', 'Feedback', 'Message System',
                                   ...
                                   'Syndicate Coordinators', 'Profile', 'RefineryCMS', 'FreeCEN Roadmap', 'Gazetteer', 'System Documentation',
      ...
      'executive_director' => ['Upload Report','GAP Report','Access Attic', 'CSV Batches', 'Communicate', 'Contacts', 'County Coordinators', 'Country Coordinators', 'Database Statistics', 'Feedback', 'FreeCen Errors', 'Gazetteer',
                               'Manage Counties', 'Manage FreeCen Coverage', 'Manage Syndicates', 'Manage Userids', 'Message System', 'Profile', 'RefineryCMS', 'FreeCEN Roadmap', 'Search Statistics', 'Search Performance', 'Site Statistics',
      ...
      'general_communication_coordinator' => ['CSV Batches', 'Communicate', 'Display Userids', 'Feedback', 'Gazetteer', 'Message System', 'Profile', 'RefineryCMS', 'FreeCEN Roadmap', 'System Documentation', 'FreeUKGenealogy  Policies'],
      ...
      'system_administrator' => ['Upload Report', 'Find Pieces','Access Attic', 'CSV Batches', 'Communicate', 'Contacts', 'Display Communications Coordinators', 'County Coordinators', 'Country Coordinators', 'Database Statistics', 'Gazetteer CSV Download', 'Feedback', 'FreeCen Errors', 'Gazetteer',
                                 'Manage Counties', 'Manage FreeCen Coverage', 'Manage Syndicates', 'Manage Userids', 'Message System', 'Place Edit Reasons', 'Place Sources', 'Physical Files', 'Profile', 'RefineryCMS', 'FreeCEN Roadmap', 'Search Statistics', 'Search Performance', 'Site Statistics',
      ...
      'technical' => ['Access Attic', 'CSV Batches', 'Communicate', 'Contacts', 'Database Statistics', 'Feedback', 'FreeCen Errors', 'Gazetteer', 'Profile', 'RefineryCMS', 'FreeCEN Roadmap','Search Statistics', 'Search Performance', 'Site Statistics',
      ...
      'website_coordinator' => ['CSV Batches', 'Communicate', 'Contacts', 'Database Statistics', 'Display Userids', 'Feedback', 'Gazetteer', 'Message System','Place Edit Reasons', 'Profile', 'RefineryCMS', 'FreeCEN Roadmap', 'System Documentation', 'FreeCEN Handbook', 'Display County Coordinators', 'Display Syndicate Coordinators',  'FreeUKGenealogy  Policies'],
