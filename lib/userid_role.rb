module UseridRole
  ...
  when 'freecen'
    OPTIONS = {
      ...
      'data_manager' => ['CSV Batches', 'Communicate', 'Contacts', 'Database Statistics', 'Display Userids', 'Display Syndicate Coordinators', 'Display County Coordinators', 'Manage Counties', 'Manage Syndicates', 'Profile',
                         'Roadmap', 'Search Place Names','FreeCEN Handbook', 'FreeUKGenealogy  Policies' ],
      ...
      'syndicate_coordinator' => ['CSV Batches', 'Communicate', 'Manage Syndicate', 'Profile', 'Roadmap', 'Search Place Names', 'FreeCEN Handbook', 'FreeUKGenealogy  Policies'],
      ...
      'technical' => ['CSV Batches', 'Communicate', 'Contacts', 'Database Statistics', 'Feedback', 'FreeCen Errors', 'Profile', 'RefineryCMS', 'Roadmap', 'Search Performance', 'Search Place Names', 'Site Statistics',
                      'System Documentation', 'FreeCEN Handbook', 'FreeUKGenealogy  Policies'],

      'transcriber' => ['CSV Batches', 'Communicate', 'Profile', 'Roadmap','Search Place Names', 'FreeCEN Handbook', 'FreeUKGenealogy  Policies'],
      'validator' => ['CSV Batches', 'Communicate', 'Profile', 'Roadmap', 'Search Place Names', 'FreeCEN Handbook', 'FreeUKGenealogy  Policies'],
