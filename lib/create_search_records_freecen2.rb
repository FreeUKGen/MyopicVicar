...
class CreateSearchRecordsFreecen2
  ...
  class << self
    ...
    def setup(fileid, number, message_file)
      ...
      freecen2_place.freecen1_vld_files << file unless freecen2_place.freecen1_vld_files.include?(file) || freecen2_place.blank?
      ...
      freecen2_place.save unless freecen2_place.blank? || freecen2_place.freecen1_vld_files.include?(file)
