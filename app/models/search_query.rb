...
class SearchQuery
  ...
  def get_quarter
    params = {}
    params[:quarternumber] = start_quarter_number..end_quarter_number
    params
  end

  def start_quarter_number
    (start_year - 1837)* 4 + start_quarter
  end

  def end_quarter_number
    (end_year - 1837)* 4 + end_quarter
  end
