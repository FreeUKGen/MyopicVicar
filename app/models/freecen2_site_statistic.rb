class Freecen2SiteStatistic
  ...
  def self.calculate(time = Time.now.utc)
    ...
    records[:total][:total][:csv_entries_incorporated] = 0
    ...
    Freecen::CENSUS_YEARS_ARRAY.each do |year|
      records[:total][year] = {}
      records[:total][year][:individuals] = 0
      records[:total][year][:dwellings] = 0
      records[:total][year][:vld_files_on_line] = 0
      records[:total][year][:csv_files] = 0
      records[:total][year][:csv_files_incorporated] = 0
      records[:total][year][:vld_entries] = 0
      records[:total][year][:csv_entries] = 0
      records[:total][year][:csv_entries_incorporated] = 0
      records[:total][year][:search_records] = 0
      records[:total][year][:added_vld_files] = 0
      records[:total][year][:added_vld_entries] = 0
      records[:total][year][:added_csv_files] = 0
      records[:total][year][:added_csv_entries] = 0
      records[:total][year][:added_csv_entries_incorporated] = 0
    end
    chaps = 0
    ChapmanCode.merge_counties.each do |county|
      ...
      records[:total][:total][:individuals] += records[county][:total][:individuals]
      records[:total][:total][:dwellings] += records[county][:total][:dwellings]
      records[:total][:total][:vld_files_on_line] += records[county][:total][:vld_files_on_line]
      records[:total][:total][:csv_files] += records[county][:total][:csv_files]
      records[:total][:total][:csv_files_incorporated] += records[county][:total][:csv_files_incorporated]
      records[:total][:total][:vld_entries] += records[county][:total][:vld_entries]
      records[:total][:total][:csv_entries] += records[county][:total][:csv_entries]
      records[:total][:total][:search_records] += records[county][:total][:search_records]
      records[:total][:total][:added_vld_files] += records[county][:total][:added_vld_files]
      records[:total][:total][:added_vld_entries] += records[county][:total][:added_vld_entries]
      records[:total][:total][:added_csv_files] += records[county][:total][:added_csv_files]
      records[:total][:total][:added_csv_entries] += records[county][:total][:added_csv_entries]
      records[:total][:total][:added_csv_entries_incorporated] += records[county][:total][:added_csv_entries_incorporated]
    end
