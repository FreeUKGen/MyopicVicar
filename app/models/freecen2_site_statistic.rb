  ...
  def self.calculate(time = Time.now.utc)
    ...
    ChapmanCode.merge_counties.each do |county|
      ...
      Freecen::CENSUS_YEARS_ARRAY.each do |year|
        ...
        records[county][year][:added_vld_files] = records[county][year][:vld_files_on_line] - previous_records[county][year][:vld_files_on_line] if previous_records.present?
        records[county][year][:added_vld_entries] = records[county][year][:vld_entries] - previous_records[county][year][:vld_entries] if previous_records.present?
        records[county][year][:added_csv_files] = records[county][year][:csv_files] - previous_records[county][year][:csv_files] if previous_records.present?
        records[county][year][:added_csv_entries] = records[county][year][:csv_entries] - previous_records[county][year][:csv_entries] if previous_records.present?
        records[county][year][:added_csv_entries_incorporated] = records[county][year][:csv_entries_incorporated] - previous_records[county][year][:csv_entries_incorporated] if previous_records.present?
        ...
        if previous_records.blank?
          records[:total][year][:added_vld_files] =  previous_records.present? ? records[:total][year][:vld_files_on_line] - previous_records[:total][year][:vld_files_on_line] : records[:total][year][:vld_files_on_line]
          records[:total][year][:added_vld_entries] = previous_records.present? ? records[:total][year][:vld_entries] - previous_records[:total][year][:vld_entries] : records[:total][year][:vld_entries]
          records[:total][year][:added_csv_files] = previous_records.present? ? records[:total][year][:csv_files] - previous_records[:total][year][:csv_files] : records[:total][year][:csv_files]
          records[:total][year][:added_csv_entries] = previous_records.present? ? records[:total][year][:csv_entries] - previous_records[:total][year][:csv_entries] : records[:total][year][:csv_entries]
          records[:total][year][:added_csv_entries_incorporated] = previous_records.present? ? records[:total][year][:csv_entries_incorporated] - previous_records[:total][year][:csv_entries_incorporated] : records[:total][year][:csv_entries_incorporated]
