...
class FreecenCsvEntry
  ...
  class << self
    ...
    def validate_civil_parish(record, previous_civil_parish)
      ...
      freecen2_civil_parish = Freecen2CivilParish.find_by(name: Freecen2Place.standard_place_name(record[:civil_parish]), year: record[:year], chapman_code: record[:piece].chapman_code)
