...
module ApplicationHelper
  ...
  def app_icons2
    {
      facebook: '<i class="fa fa-facebook-square fa-3x" title="facebook"></i></i><span class="accessibility">facebook</span>',
      news: '<i class="fa fa-rss-square fa-3x" title="news"></i><span class="accessibility">FreeUKGenealogy News</span></i>',
      twitter: '<i class="fa fa-twitter-square fa-3x" title="twitter"></i><span class="accessibility">twitter</span></i>',
      pinterest: '<i class="fa fa-pinterest-square fa-3x" title="pinterest"></i><span class="accessibility">pinterest</span></i>',
      instagram: '<i class="fa fa-instagram fa-3x" title="instagram"></i><span class="accessibility">instagram</span></i>'
    }
  end
...
def helpful_anchors
    {
      ...
      fugNews: 'News about FreeUKGenealogy<span class="accessibility">Opens in new window</span>',
