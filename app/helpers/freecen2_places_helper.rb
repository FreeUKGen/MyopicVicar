module Freecen2PlacesHelper
  ...
  # No county is pre-selected; the user chooses one on the recipient-selection page.
  def communicate_action_county_coordinator_gazetteer_path(search:, allowed_chapmans:)
