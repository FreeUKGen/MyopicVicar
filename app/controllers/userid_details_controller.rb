...
class UseridDetailsController < ApplicationController
  ...
  def transcriber_statistics
    ...
    @percentage_active_existing_users_who_accepted_transcription_agreement = @current_user.return_percentage_all_existing_active_users_accepted_transcriber_agreement
