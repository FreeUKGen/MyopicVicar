...
Refinery::Authentication::Devise::User.class_eval do
  ...
  attr_accessor :userid_detail_id, :reset_password_token, :reset_password_sent_at, :username, :password, :email
  ...
  def userid_detail_id
    userid_detail_id = self[:userid_detail_id]
  end
